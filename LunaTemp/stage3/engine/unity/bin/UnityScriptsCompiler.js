...
if ( TRACE ) { TRACE( "SimpleDodgeGame#WarnIfMissingSpriteSetup", this ); }
                ...
                if (this.hasLoggedMissingSpriteConfig) {
                    return;
                }

                if (this.GetAnyConfiguredOrbSprite() != null) {
                    return;
                }
