...
public sealed class SimpleDodgeGame : MonoBehaviour
{
    ...
    private void DragHeldOrbToward([Bridge.Ref] Vector2Int targetCell)
    {
    ...
    private Orb CreateOrb(int type, [Bridge.Ref] Vector3 worldPosition)
    {
    ...
    private void SwapCells([Bridge.Ref] Vector2Int a, [Bridge.Ref] Vector2Int b)
    {
    ...
    private bool TryWorldToCell([Bridge.Ref] Vector3 worldPosition, out Vector2Int cell)
    {
    ...
    private bool IsInsideBoard([Bridge.Ref] Vector2Int cell)
    {
